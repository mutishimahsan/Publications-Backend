    ...
    namespace Domain.Entities
    {
        public class Product : AuditableEntity
        {
            ...
            public long? DigitalFileSize { get; set; }
            public string? DigitalFileMimeType { get; set; }
            public int? DownloadExpiryDays { get; set; } = 30;

        public virtual ICollection<DigitalAccess> DigitalAccesses { get; set; } = new List<DigitalAccess>();
